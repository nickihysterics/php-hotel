...
2) Автозапуск с открытием страниц (сразу откроет сайт, админку и phpMyAdmin):
...
3) Установите зависимости PHP (по желанию, для разработки):
